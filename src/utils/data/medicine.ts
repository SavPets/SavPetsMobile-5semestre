  ...
  export const MEDICINE: Medicine[] = [
    {
      ...
      observation: "Para filhotes a partir de 2 meses de idade e adultos. Consulte o veterinário para dosagem.",
      amount : "1 comprimido",
      arrivalDate : "2024-03-15",
      leaflet : "https://coveli.com.br/wp-content/uploads/sites/95/2021/02/leaflet -blu.pdf",
      provider : "AgroPet",
    },
    {
      id: "2",
      ...
      observation: "Somente com prescrição veterinária. Siga as instruções da leaflet .",
      ...
      },
      {
        ...
        observation: "Uso tópico. Evite contato com olhos e mucosas. Consulte o veterinário.",
        amount : "250ml",
        arrivalDate : "2024-02-22",
        leaflet : "https://www.petshopamarosbichos.com.br/produto/shampoo-sebotrat-s-seborreia-seca-200ml-70467",
        provider: "DermaPet",
      },
  ]
